...
! function(y, M, L, a) {
    y.fn.flipBook = function(e) {
        ...
        loadPage: function(e, t, o) {
            console.log("page: "+JSON.stringify(this.options.pages[e].src));
            console.log("page: "+JSON.stringify(this.options.pages[e].img));
            var i, n = this,
            ...
            this.options.pdfMode && !s ? this.loadPageFromPdf(e, t, o) : (i = (n = this).options.pages[e]).img ? i.imgLoaded ? n.pageLoaded({
                ...
                n.loadPage(e, t, o)
            }, 500) : (i.img = L.createElement("img"), i.img.setAttribute("data-id", e), i.img.onload = function() {
