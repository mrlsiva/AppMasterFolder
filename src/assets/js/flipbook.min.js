...
! function(y, M, L, a) {
    y.fn.flipBook = function(e) {
        ...
        }), this.model = P, S.lightBox ? (S.btnClose.enabled = !1, this.lightbox = new FLIPBOOK.Lightbox(this, this.wrapper, S), this.lightboxStartedTimes = 0, this.wrapper.css("background", "none"), this.bookLayer.css("background", "none"), this.book.css("background", "none"), this.preloader.appendTo(this.$body).css("position", "fixed"), this.$elem.css("cursor", "pointer").bind("tap click", function(e) {
        ...
        initPdf: function() {
            if (!this.started) {
                ...
                }), PDFJS = pdfjsLib, pdfjsLib.externalLinkTarget = pdfjsLib.LinkTarget.BLANK, pdfjsLib.GlobalWorkerOptions.workerSrc = this.options.pdfjsworkerSrc || FLIPBOOK.pdfjsworkerSrc, "https:" == location.protocol ? t.options.pdfUrl = t.options.pdfUrl.replace("https://", "https://") : "http:" == location.protocol && (t.options.pdfUrl = t.options.pdfUrl.replace("https://", "https://"));
                var e = {
                    cMapPacked: !0,
                    cMapUrl: "cmaps/",
                    disableAutoFetch: !0,
        ...
        loadPage: function(e, t, o) {
            ...
            }, "webgl" == this.options.viewMode && (i.img.crossOrigin = "Anonymous"), "https:" == location.protocol ? i.src = i.src.replace("https://", "https://") : "https:" == location.protocol && (i.src = i.src.replace("https://", "https://")), i.img.src = i.src)
        },
        ...
        createMenuHeader: function(e, t, o) {
            ...
            this.createIcon(this.options.btnClose, null, !1).appendTo(s)
        },
        createToc: function() {
            var i = this,
